...
export const TIMELINE_ACTIVITY_STANDARD_FIELD_IDS = {
  ...
  materialPrice: 'd7e8f9a0-b1c2-3d4e-5f6a-7b8c9d0e1f2a',
  materialPriceHistory: 'e8f9a0b1-c2d3-4e5f-6a7b-8c9d0e1f2a3b',
  priceContract: 'f9a0b1c2-d3e4-5f6a-7b8c-9d0e1f2a3b4c',
  materialRequest: 'a0b1c2d3-e4f5-6a7b-8c9d-0e1f2a3b4c5d',
  materialApproval: 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e',
  boq: 'c2d3e4f5-a6b7-8c9d-0e1f-2a3b4c5d6e7f',
  custom: '20202020-4a71-41b0-9f83-9cdcca3f8b14',
...
export const MATERIAL_STANDARD_FIELD_IDS = {
  ...
  materialPrices: 'f1e2d3c4-b5a6-9780-1234-567890abcdef',
  materialRequests: 'a2b3c4d5-e6f7-8901-2345-6789abcdef01',
  materialApprovals: 'b3c4d5e6-f7a8-9012-3456-789abcdef012',
  boqs: 'c4d5e6f7-a8b9-0123-4567-89abcdef0123',
...
export const MANUFACTURER_STANDARD_FIELD_IDS = {
  ...
  materialPrices: 'a8b9c0d1-e2f3-4a5b-6c7d-8e9f0a1b2c3d',
  materialRequests: 'b9c0d1e2-f3a4-5b6c-7d8e-9f0a1b2c3d4e',
  materialApprovals: 'c0d1e2f3-a4b5-6c7d-8e9f-0a1b2c3d4e5f',
  boqs: 'd1e2f3a4-b5c6-7d8e-9f0a-1b2c3d4e5f6a',
...
export const SUPPLIER_STANDARD_FIELD_IDS = {
  ...
  materialPrices: 'd5e6f7a8-b9c0-1d2e-3f4a-5b6c7d8e9f0a',
  priceContracts: 'e6f7a8b9-c0d1-2e3f-4a5b-6c7d8e9f0a1b',
  materialApprovals: 'f7a8b9c0-d1e2-3f4a-5b6c-7d8e9f0a1b2c',
...
export const PROJECT_STANDARD_FIELD_IDS = {
  ...
  priceContracts: 'e2f3a4b5-c6d7-8e9f-0a1b-2c3d4e5f6a7b',
  materialRequests: 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e',
  materialApprovals: 'c2d3e4f5-a6b7-8c9d-0e1f-2a3b4c5d6e7f',
  boqs: 'd3e4f5a6-b7c8-9d0e-1f2a-3b4c5d6e7f8a',
...
// Phase 5.1 - Material Price
export const MATERIAL_PRICE_STANDARD_FIELD_IDS = {
  material: 'fccbb08c-407e-4b19-b562-07d4b1f8224a',
  materialId: '12df6035-b02f-4f18-bbe8-b254bd64dbd5',
  supplier: '36aa3790-9c60-4f5f-98ea-b7a2e1be015e',
  supplierId: '9b5d56a7-8e7a-424b-8e9c-ebf7c0d896a5',
  model: '31aeb4c9-6b9c-4a25-9066-95b7403bf9e9',
  unit: '89c894e0-9582-4868-bd65-c071041a8989',
  currentPrice: '7103aaa3-0132-49a8-8321-bfd78f879548',
  laborCost: '80cf366d-5b36-477e-8e5e-1ad3a008eab3',
  manufacturer: 'e9c394de-6df6-481f-9c77-279a6209469b',
  manufacturerId: '4e2b448d-6e3b-4bbc-b947-c211a9b81af9',
  leadTimeMinDays: '34da700d-82d5-430d-9c76-141ea1ced23f',
  leadTimeMaxDays: '1f4ead33-fc22-4ebe-b946-ff312663e9ad',
  priceUpdatedAt: '4bdd6b5a-cb28-4334-b439-4384cd557011',
  discountPercentage: '57265eee-0b70-40a1-aaf2-da8e36781df4',
  note: 'a1b2c3d4-e5f6-7890-abcd-1234567890ab',
  priceContract: 'b2c3d4e5-f6a7-8901-bcde-234567890abc',
  priceContractId: 'c3d4e5f6-a789-0123-cdef-34567890abcd',
  priceType: 'd4e5f6a7-8901-2345-def0-4567890abcde',
  position: 'e5f6a789-0123-4567-ef01-567890abcdef',
  createdBy: 'f6a78901-2345-6789-f012-67890abcdef0',
  searchVector: 'a7890123-4567-890a-0123-7890abcdef01',
  timelineActivities: 'e66f57b3-5072-406d-8631-c603ce124ccc',
  materialPriceHistories: 'c9012345-6789-0abc-2345-90abcdef0123',
} as const;

// Phase 5.2 - Material Price History
export const MATERIAL_PRICE_HISTORY_STANDARD_FIELD_IDS = {
  materialPrice: 'd0123456-789a-bcde-3456-0abcdef01234',
  materialPriceId: 'e1234567-89ab-cdef-4567-abcdef012345',
  oldPrice: 'f2345678-9abc-def0-5678-bcdef0123456',
  newPrice: 'a3456789-abcd-ef01-6789-cdef01234567',
  changedAt: 'b4567890-bcde-f012-7890-def012345678',
  changedBy: 'c5678901-cdef-0123-8901-ef0123456789',
  fileId: 'd6789012-def0-1234-9012-f01234567890',
  reason: 'e7890123-ef01-2345-0123-012345678901',
  position: 'f8901234-f012-3456-1234-123456789012',
  createdBy: 'a9012345-0123-4567-2345-234567890123',
  searchVector: 'b0123456-1234-5678-3456-345678901234',
  timelineActivities: 'c1234567-2345-6789-4567-456789012345',
} as const;

// Phase 5.3 - Price Contract
export const PRICE_CONTRACT_STANDARD_FIELD_IDS = {
  contractCode: 'd2345678-3456-789a-5678-567890123456',
  supplier: 'e3456789-4567-89ab-6789-678901234567',
  supplierId: 'f4567890-5678-9abc-7890-789012345678',
  project: 'a5678901-6789-abcd-8901-890123456789',
  projectId: 'b6789012-789a-bcde-9012-901234567890',
  contractName: 'c7890123-89ab-cdef-0123-012345678901',
  startDate: 'd8901234-9abc-def0-1234-123456789012',
  endDate: 'e9012345-abcd-ef01-2345-234567890123',
  status: 'f0123456-bcde-f012-3456-345678901234',
  description: 'a1234567-cdef-0123-4567-456789012345',
  approvedBy: 'b2345678-def0-1234-5678-567890123456',
  approvedAt: 'c3456789-ef01-2345-6789-678901234567',
  termsAndConditions: 'd4567890-f012-3456-7890-789012345678',
  position: 'e5678901-0123-4567-8901-890123456789',
  createdBy: 'f6789012-1234-5678-9012-901234567890',
  searchVector: 'a7890123-2345-6789-0123-012345678901',
  timelineActivities: 'b8901234-3456-789a-1234-123456789012',
  materialPrices: 'c9012345-4567-89ab-2345-234567890123',
} as const;

// Phase 6.1 - Material Request
export const MATERIAL_REQUEST_STANDARD_FIELD_IDS = {
  materialRequestCode: 'c9012345-4567-89ab-2345-234567890123',
  material: 'd0123456-5678-9abc-3456-345678901234',
  materialId: 'e1234567-6789-abcd-4567-456789012345',
  materialCode: 'f2345678-789a-bcde-5678-567890123456',
  materialName: 'a3456789-89ab-cdef-6789-678901234567',
  specification: 'b4567890-9abc-def0-7890-789012345678',
  unit: 'c5678901-abcd-ef01-8901-890123456789',
  project: 'd6789012-bcde-f012-9012-901234567890',
  projectId: 'e7890123-cdef-0123-0123-012345678901',
  quantity: 'f8901234-def0-1234-1234-123456789012',
  requestedDate: 'a9012345-ef01-2345-2345-234567890123',
  requiredDate: 'b0123456-f012-3456-3456-345678901234',
  status: 'c1234567-0123-4567-4567-456789012345',
  requestName: 'd2345678-1234-5678-5678-567890123456',
  category: 'e3456789-2345-6789-6789-678901234567',
  requestedBy: 'f4567890-3456-789a-7890-789012345678',
  image: 'a5678901-4567-89ab-8901-890123456789',
  manufacturer: 'b6789012-5678-9abc-9012-901234567890',
  manufacturerId: 'c7890123-6789-abcd-0123-012345678901',
  manufacturerName: 'd8901234-789a-bcde-1234-123456789012',
  note: 'e9012345-89ab-cdef-2345-234567890123',
  position: 'f0123456-9abc-def0-3456-345678901234',
  createdBy: 'a1234567-abcd-ef01-4567-456789012345',
  searchVector: 'b2345678-bcde-f012-5678-567890123456',
  timelineActivities: 'c3456789-cdef-0123-6789-678901234567',
  materialPurchaseRequests: 'd4567890-def0-1234-7890-789012345678',
} as const;

// Phase 6.2 - Material Approval
export const MATERIAL_APPROVAL_STANDARD_FIELD_IDS = {
  materialApprovalCode: 'e5678901-ef01-2345-8901-890123456789',
  materialApprovalName: 'f6789012-f012-3456-9012-901234567890',
  material: 'a7890123-0123-4567-0123-012345678901',
  materialId: 'b8901234-1234-5678-1234-123456789012',
  project: 'c9012345-2345-6789-2345-234567890123',
  projectId: 'd0123456-3456-789a-3456-345678901234',
  status: 'e1234567-4567-89ab-4567-456789012345',
  approvedDate: 'f2345678-5678-9abc-5678-567890123456',
  attachment: 'a3456789-6789-abcd-6789-678901234567',
  supplier: 'b4567890-789a-bcde-7890-789012345678',
  supplierId: 'c5678901-89ab-cdef-8901-890123456789',
  manufacturer: 'd6789012-9abc-def0-9012-901234567890',
  manufacturerId: 'e7890123-abcd-ef01-0123-012345678901',
  note: 'f8901234-bcde-f012-1234-123456789012',
  position: 'a9012345-cdef-0123-2345-234567890123',
  createdBy: 'b0123456-def0-1234-3456-345678901234',
  searchVector: 'c1234567-ef01-2345-4567-456789012345',
  timelineActivities: 'd2345678-f012-3456-5678-567890123456',
} as const;

// Phase 6.3 - BoQ (Bill of Quantities)
export const BOQ_STANDARD_FIELD_IDS = {
  classification: 'e3456789-0123-4567-6789-678901234567',
  type: 'f4567890-1234-5678-7890-789012345678',
  material: 'a5678901-2345-6789-8901-890123456789',
  materialId: 'b6789012-3456-789a-9012-901234567890',
  project: 'c7890123-4567-89ab-0123-012345678901',
  projectId: 'd8901234-5678-9abc-1234-123456789012',
  description: 'e9012345-6789-abcd-2345-234567890123',
  technicalSpecs: 'f0123456-789a-bcde-3456-345678901234',
  model: 'a1234567-89ab-cdef-4567-456789012345',
  image: 'b2345678-9abc-def0-5678-567890123456',
  unit: 'c3456789-abcd-ef01-6789-678901234567',
  manufacturer: 'd4567890-bcde-f012-7890-789012345678',
  manufacturerId: 'e5678901-cdef-0123-8901-890123456789',
  origin: 'f6789012-def0-1234-9012-901234567890',
  quantity: 'a7890123-ef01-2345-0123-012345678901',
  unitPrice: 'b8901234-f012-3456-1234-123456789012',
  laborCost: 'c9012345-0123-4567-2345-234567890123',
  materialTotalPrice: 'd0123456-1234-5678-3456-345678901234',
  laborTotalPrice: 'e1234567-2345-6789-4567-456789012345',
  totalPrice: 'f2345678-3456-789a-5678-567890123456',
  amount: 'a3456789-4567-89ab-6789-678901234567',
  note: 'b4567890-5678-9abc-7890-789012345678',
  title: 'c5678901-6789-abcd-8901-890123456789',
  parent: 'd6789012-789a-bcde-9012-901234567890',
  parentId: 'e7890123-89ab-cdef-0123-012345678901',
  createdByUser: 'f8901234-9abc-def0-1234-123456789012',
  brand: 'a9012345-abcd-ef01-2345-234567890123',
  position: 'b0123456-bcde-f012-3456-345678901234',
  createdBy: 'c1234567-cdef-0123-4567-456789012345',
  searchVector: 'd2345678-def0-1234-5678-567890123456',
  timelineActivities: 'e3456789-ef01-2345-6789-678901234567',
  children: 'f4567890-f012-3456-7890-789012345678',
} as const;
...
export const STANDARD_OBJECT_FIELD_IDS = {
  ...
  materialPrice: MATERIAL_PRICE_STANDARD_FIELD_IDS,
  materialPriceHistory: MATERIAL_PRICE_HISTORY_STANDARD_FIELD_IDS,
  priceContract: PRICE_CONTRACT_STANDARD_FIELD_IDS,
  materialRequest: MATERIAL_REQUEST_STANDARD_FIELD_IDS,
  materialApproval: MATERIAL_APPROVAL_STANDARD_FIELD_IDS,
  boq: BOQ_STANDARD_FIELD_IDS,
