export const STANDARD_OBJECT_ICONS = {
  ...
  materialPrice: 'IconCurrencyDollar',
  materialPriceHistory: 'IconHistory',
  priceContract: 'IconFileContract',
  materialRequest: 'IconFileText',
  materialApproval: 'IconCircleCheck',
  boq: 'IconListNumbers',
  supplier: 'IconTruck',
